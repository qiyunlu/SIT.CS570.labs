// This is Lu's red-black tree lab.

var redBlackTree = null;

// Copy from "https://www.npmjs.com/package/redblack".
// redblack.js  scttnlsn
(function() {
...
tree.insert('occupation', 'student');
tree.insert('year', '2016');
tree.insert('gpa', '4.0');
tree.insert('lab', 'yes');
tree.insert('assignment', 'no');
tree.insert('department', 'cs');
// Retrieve the value of gpa and department.
var a = tree.get('gpa');
var b = tree.get('department');
// Display it on the screen.
console.log(a);
console.log(b);
// Delete function is tree.delete(key).
